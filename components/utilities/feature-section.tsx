...
export default function FeatureSection({
    ...
    return (
        <section
            className={`w-full text-white py-12 md:py-16 lg:py-20 my-10 px-4 md:px-8 ${className}`}
            ...
            <div className="mx-auto max-w-7xl">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    <div className="relative flex items-center justify-center">
                        <div className="rounded-2xl p-8 md:p-10 lg:p-12 w-full max-w-[600px] rounded-2xl">
                            <Image
                                src={imageSrc}
                                alt={imageAlt}
                                width={1200}
